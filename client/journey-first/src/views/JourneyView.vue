<template>
  <div class="journey">
    ...
    <p><strong>NEW:</strong> <a href="https://github.com/sebastianrothbucher/journey-first#claude-code-skill" target="_blank">Claude Code skill available</a> - create journeys directly in your terminal with AI coaching! <a href="https://github.com/sebastianrothbucher/journey-first/blob/main/README.md#claude-code-skill" target="_blank">Learn more →</a><br/>
    This tool helps you get a clear and detailed customer journey - and get the insights out to everyone in your team. Once you went through the steps - you'll have a very clear picture - and you can also start an interactive <em>briefing</em> to get your team up to speed. If you want to know how a final result can look like, load the <a href="#" @click="sampleJourney()">sample</a><br/>
